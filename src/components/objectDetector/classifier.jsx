...
export function ObjectDetector(props) {
    ...
    const detectObjectsOnImage = async (imageElement, imgSize) => {
        ...
        const converted_image = tf.browser.fromPixels(imageElement)
        const resized_image = tf.image.resizeBilinear(converted_image, [IMAGE_WIDTH, IMAGE_HEIGHT])

        const expandedImageTensor = tf.expandDims(resized_image, 0);
